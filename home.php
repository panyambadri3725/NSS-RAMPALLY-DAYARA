...
<script src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/user.svg" width="35px" alt="Profile" class="rounded-circle">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <?php
                  ...
                  $que = "SELECT Total FROM transcation WHERE Pay_date BETWEEN '$d1' AND '$d2';";
                  $que1 = "SELECT DISTINCT(House_number) FROM transcation WHERE Pay_date BETWEEN '$d1' AND '$d2';";
                  
                  $rec=mysqli_query($con,$que);
                  $rec1 = mysqli_query($con,$que1);
                  $number_of_villagers_paid=mysqli_num_rows($rec1);
                  $amount_collected=0;
                  if(mysqli_num_rows($rec)>0){
                    while($row = mysqli_fetch_assoc($rec)){
                      $amount_collected+=$row['Total'];
                    }
                  }
                ...
                if(mysqli_num_rows($result)>0) 
                  {
                    while($row1 = mysqli_fetch_assoc($result)) { 
                      ...
                      $curyear=date('Y');
                      if($year!=$curyear){
                          $que = "select * from arrears;";
                          $result1 = mysqli_query($con,$que);
                          if(mysqli_num_rows($result1)>0) 
                          {
                              while($row = mysqli_fetch_assoc($result1)) { 
                                  $House_number = $row["House_number"];
                                  $original_current = $row["Current"];
                                  $new_arrear=$row["Arrears"]+$original_current;
                                  $new_total = $new_arrear+$original_current;
                                  $que2 = "update arrears set Arrears='$new_arrear',Current = '$original_current',Total ='$new_total' where House_number='$House_number' ";
                                  $record2 = mysqli_query($con,$que2);
                    
                              }
                          }
                          $que3 = "update login set Year = '$curyear' where Username='$user' ";
                ...
                <div class="card-body">
                  <h5 class="card-title">Amount collected <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $amount_collected; ?></h6>
                      <span class="text-success small pt-1 fw-bold"><?php echo $number_of_villagers_paid; ?></span> <span class="text-muted small pt-2 ps-1">members paid</span>
            ...
            <div class="col-xxl-4 col-xl-6">
              ...
              <div class="card info-card customers-card">
                ...
                ?>
                <div class="card-body">
                  <h5 class="card-title">Villagers <span>| of Dayara</span></h5>
            ...
            <div class="col-lg-10">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Gram Panchayath Rampally Dayara Village</h5>
    
                  <!-- Slides with controls -->
                  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="assets/img/rampally4.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/img/rampally2.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/img/rampally.jpg" class="d-block w-100" alt="...">
                      </div>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="assets/img/artical1.jpg" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item">
                        <img src="assets/img/artical2.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="assets/img/artical3.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <!-- <div class="carousel-item">
                        <img src="assets/img/artical4.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Rampally Dayara Village</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
