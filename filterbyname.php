...
if(!isset($_SESSION["name"]) or !isset($_SESSION["UserType"]) or $_SESSION["UserType"]!="admin") {
  ...
  if(isset($_SESSION["individualmessagestatus"])){
    //echo '<script>alert("Message sent Successfully");</script>';
    if($_SESSION["individualmessagestatus"]==1){
    //    //echo '<script type="text/javascript">s_alert();</script>';
        echo '<script>alert("Message sent Successfully");</script>';
     }
     if($_SESSION["individualmessagestatus"]==2){
       echo '<script>alert("Mobile Number Not Found");</script>';
     }
    unset($_SESSION["individualmessagestatus"]);
  }
...
<div class="pagetitle">
  <h1>Filter By House Number</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="home.php">Home</a></li>
      <li class="breadcrumb-item">Analyse Data</li>
      <li class="breadcrumb-item active">Filter By House Number</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="col-12">
        <div class="card recent-sales overflow-auto">
          <div class="card-body">
            ...
            <form action="" name="filterbyname" method="post" >
              <br>
              <br>
                    ...
                    <div class="tab-content pt-2">
                      ...
                      <div class="text-center">
                        ...
                        <form action="send_message_single_user.php" method="post"> 
                          <input type="hidden" name="phonenumber" value="<?php echo $mn; ?>" />
                          <input type="hidden" name="taxvalue" value="<?php echo $tt; ?>" />
                          <input type="submit" name="sendsms" class="btn btn-success" value="Send SMS" />
                        </form>
                      </div>
                      
                      <!-- <form action="send_message_single_user.php" method="post"> 
                       <input type="hidden" name="housenumber" value="<?php echo $hn; ?>" >
                  ...
                  <div id="formprint">
                    ...
                    if(mysqli_num_rows($res3)>0)
                    {
                        ...
                        echo "<tr>";
                          ...
                          echo "<th cellpadding='8'><div class='col-lg-9 col-md-8'>$on</div></th>";
                        echo "</tr>";
                        echo "<tr>";
