...
<script>
        ...
        function w_alert()
        {
            toastr.warning("House number not found")
        }
    </script>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="deleteuser.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View and Delete The Users</h1>
      <nav>
        <ol class="breadcrumb">
                    ...
                    <form name="delete" method="post" action="">
                      ...
                      <div class="row justify-content-center">
                        <div class="col-sm-4 ml-auto">
                          <input class="form-control" type="text" name="House_Number" placeholder="Enter House Number" required>
                        </div>                
                      </div>
                      <br>
                      <!-- <div class="col-md-6">
                        <div class="form-floating">
                          <input class="form-control" type="text" name="House_Number" placeholder="Enter user data">
                          <label for="floatingEmail">Enter user data</label>
                        </div>
                      </div> -->
                ...
                <!-- <table class="table table-striped table-hover datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-danger" style="width: 30px; padding: 2px;"><i class="bi bi-trash"></i></button></td>
                    </tr>
                    <tr>
  ...
  <!-- Vendor JS Files -->
  <script src="assets/vendor/apexcharts/apexcharts.min.js"></sc>
...
$temp = "select * from main where REPLACE(REPLACE(House_number,' ',''),'?','')=REPLACE('$House_Number',' ','');";
...
if(mysqli_num_rows($temp2)>0){
    ...
    // echo "<script>alert('House number not found')</script>";
    echo '<script type="text/javascript">w_alert();</script>';
}
$temp = "select * from arrears where REPLACE(REPLACE(House_number,' ',''),'?','')=REPLACE('$House_Number',' ','');";
$temp2 = mysqli_query($con,$temp);
if(mysqli_num_rows($temp2)>0){
    $que="delete from arrears where House_number='$House_Number';";
    $record=mysqli_query($con,$que);
