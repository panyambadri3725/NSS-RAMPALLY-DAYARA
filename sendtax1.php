...
<script src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="sendtax1.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Send Tax Bill to Users</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
          <li class="breadcrumb-item">Messages</li>
          <li class="breadcrumb-item active">Send Tax</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <!-- <div style="width: 0%; height: 30px; background-color: #4CAF50;" id="prog"></div>
      <br> -->

        <!-- <form action="sendtaxcode.php" method="post">
                    <input type="submit" name="sendtax" class="btn btn-primary center" value="Send Tax" data-bs-toggle="modal" data-bs-target="#modalDialogScrollable">
      </form> -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
             <div class="card-body">
              <h5 class="card-title">Messages are sent via SMS</h5>
              <p>Don't click send button multiple time.</p>
              ...
              <div class="row">
                <div class="col text-center">
                  <p id="label">--</p>
                  <div style="width: 100%; height: 25px; border-radius:10px; background-color: #4CAF50;" id="prog"></div>
                  <br>

                  <form action="sendtaxcode.php" method="post">
                      <input type="submit" name="sendtax" class="btn btn-primary center" value="Send Tax" >
                  </form>
                </div>
              </div> 
...
<?php
//echo '<script>alert("'.$_SESSION["sendtaxstatus"].'");</script>';
  
                 if(isset($_SESSION["sendtaxstatus"])){
                   ...
                   for ($i = 1; $i <= $total; $i++) {
                       ...
                       sleep(1);
                       echo '<script>document.getElementById("prog").style.width="'.$progress.'%";</script>';
                       echo '<script>document.getElementById("label").innerHTML = "Sending Bills To User '.$progress.'%";</script>';
                       ob_flush(); 
                       flush();
                   }
                   echo '<script>document.getElementById("label").innerHTML = "Process Completed '.$progress.'%";</script>';
                   unset($_SESSION["sendtaxstatus"]);
                 }
                ?>