...
<script>
        ...
        function i_alert()
        {
            toastr.info("House Number Not Found!")
        }
        function w_alert()
        {
            toastr.warning("Database Load Error")
        }
    </script>
...
<script src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
            ...
            <div class="card-body">
              ...
              <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" name = "House_Number" id="HouseNumber" value="<?php echo $k; ?>" placeholder="House Number" Required>
              ...
              <form action="updatestatuscode.php" class="row g-3" method="post" name="MyForm">
                <!-- <li class="nav-item d-block d-lg-none">
                    <a class="nav-link nav-icon search-bar-toggle " href="#">
                      <i class="bi bi-search"></i>
                    </a>
                  </li> -->
                  <input type="hidden" name="House_Number" value="<?php echo $k;?>" >
               ...
               <form class="row g-3" method="post" name="MyForm2" > -->
                <div class="col-md-6">
                    <div class="form-floating">
                      <input type="text" name="arr" class="form-control" id="Arrears_Pay" onchange="updateResult()" placeholder="Arrears Amount paying" Required>
                      <label for="floatingPassword">Arrears Amount paying</label>
                    </div>
                  </div>
                <div class="col-6">
                    <div class="form-floating">
                        <input type="text" name="curr" class="form-control" id="Current_Pay" onchange="updateResult()" placeholder="Current Amount paying" Required>
                      <label for="floatingTextarea">Current Amount paying</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
                  ...
                  <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" name="receipt" class="form-control" id="ReceiptNumber"   placeholder="Receipt Number" Required>
                ...
                <div class="text-center">
                  ...
                  <!-- <form action="send_message_single_user.php" method="post"> 
                    <input type="hidden" name="housenumber" value="<?php echo $k; ?>" >
  ...
  function updateResult() {
    var num1 = document.getElementsByName("arr").value;
    var num2 =document.getElementsByName("curr").value;
...
if(isset($_SESSION["DatabaseLoadstatus"])){
  echo '<script type="text/javascript">w_alert();</script>';
  unset($_SESSION["DatebaseLoadstatus"]);
}
...
if(isset($_SESSION["Housenumberstatus"])){
  echo '<script type="text/javascript">i_alert();</script>';
  unset($_SESSION["Housenumberstatus"]);
}
$val=NULL;
  $i=NULL;
  $j=NULL;
