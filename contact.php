...
<script>
        ...
        function s_alert()
        {
            toastr.success("Email Send Successfully To Developer")
        }
        function e_alert()
        { 
            toastr.error("Email could not be sent. Mailer Error:")
        }
        function i_alert()
        {
...
<script src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">We're here for you <strong>GCET TEAM</strong></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="mailsender.php" >
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="email" name="email" value='19r11a05b5@gcet.edu.in' placeholder="Enter your email" required disabled>
                    <label for="Name">Email</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="subject" name="subject" placeholder="Enter your subject of query" required>
                    <label for="Name">Subject</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <textarea class="form-control" placeholder="Enter content" name="message" id="message" style="height: 100px;" required></textarea>
