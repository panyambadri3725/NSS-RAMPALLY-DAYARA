    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="villagersData.php" class="active">
      ...
      <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <div class="card-body">
                 <h5 class="card-title"><span>Select initial and end Date, to know the Transactions between the Dates.</span></h5>
                <form name = "date" method = "post">
                
                <div class="row justify-content-center">
                <div class="col-sm-2 text-center">
                    <button type="submit" name="fetch" class="btn btn-success" >Fetch Details</button>
                  </div>
                </div>
                </form>
                ...
                <table id="example" class="table table-striped table-hover datatable">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">House Tax per year</th>
                      <th scope="col">Library Tax per year</th>
                          ...
                          $inc=1;
                            while ($rows = $rec->fetch_assoc())
                            {
                                ...
                                <tr>
                                    ...
                                    <td>".$rows['Father_Husband_name']."</td>
                                    <td>".$rows['Mobile_number']."</td>
                                    <td>".$rows['Date_of_assessment']."</td>
                                    <td>".$rows['House_tax']."</td>
                                    <td>".$rows['Library_tax']."</td>
                                    <td>".$rows['Amount']."</td>
